...
if __name__ == "__main__":
    ...
    with MultiprocessingEvaluator(vensimModel) as evaluator:
        results, convergence = evaluator.optimize(nfe=500000, searchover='levers', convergence=convergence_metrics,
                                      epsilons=[0.0001,] * len(vensimModel.outcomes) , Scenario=ref_scen)


    results.to_excel('./Data/results_convergence7_supercomp2.xlsx')
    convergence.to_excel('./Data/conv_convergence7_supercomp2.xlsx')
